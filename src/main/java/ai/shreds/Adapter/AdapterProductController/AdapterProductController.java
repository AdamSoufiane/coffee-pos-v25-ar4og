package ai.shreds.adapter; 
 ...
 public class AdapterProductController { 
     ...
     public ResponseEntity<?> getProductsByCategory(@RequestParam @Valid @NotNull String categoryId) { 
         try { 
     ...
     public ResponseEntity<?> searchProducts(@RequestBody @Valid @NotNull SharedSearchCriteria searchCriteria) { 
         try { 
 ...
 // Implementation Note: Use Lombok annotations like @Getter, @Setter, @AllArgsConstructor, and @NoArgsConstructor to reduce boilerplate code.
...
import ai.shreds.domain.ItemNotFoundException;
...
public class AdapterOrderController {
    ...
    @PostMapping
    public ResponseEntity<SharedOrderResponseDTO> createOrder(@Valid @RequestBody @NotNull SharedCreateOrderRequestParams request) {

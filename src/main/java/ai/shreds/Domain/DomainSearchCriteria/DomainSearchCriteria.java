package ai.shreds.domain; 
 ...
 public class DomainSearchCriteria { 
     ...
     /** 
      * Constructor to initialize the search criteria fields with validation. 
      * 
      * @param name        the name to search for 
      * @param description the description to search for 
      * @throws IllegalArgumentException if any of the search criteria are empty or improperly formatted 
      */ 
     public DomainSearchCriteria(String name, String description) { 
         validateCriteria(name, description); 
         this.name = name; 
